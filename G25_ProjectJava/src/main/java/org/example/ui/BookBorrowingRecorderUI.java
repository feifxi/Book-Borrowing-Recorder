...
public class BookBorrowingRecorderUI {
    ...
    public BookBorrowingRecorderUI(boolean useDatabase){
        if (useDatabase){
            service = new BookBorrowingRecorder(       // Use Database
                    new DBBookRepository(),
                    new DBCustomerRepository(),
                    new DBBorrowRecordRepository());
        }
        else {      // If useDatabase is false will you file storage instead
    ...
    public BookBorrowingRecorderUI(){     // No augument constructor would use in-memory storage
        service = new BookBorrowingRecorder(
