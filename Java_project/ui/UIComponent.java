...
public class UIComponent {
    ...
    public UIComponent(LibraryService service){
    ...
    public void listAllBooks(){
        ...
        if (someBook == null){
            System.out.println("| "+String.format("%-100s",message) +" |");
        }
        stream.forEach(book -> {
            System.out.println(
            "| " + book.getId() + " | "
    ...
    public void listAllCustomers(){
        ...
        if (someCustomer == null){
            System.out.println("| "+String.format("%-64s","There is no customer") +" |");
        }
    ...
    public void listAllRecords(){
        ...
        if (someRecord == null){
            System.out.println("| "+String.format("%-122s",message) +" |");
        }
        stream.forEach(r -> {
            System.out.println( 
            "| " + r.getRecordId() + " | "
    ...
    public void credit(){
        String credit = clearScreen + """
            ...
            | 66130500125 | Suchai Cholchaipaisal  |   Cheif Monkey Officer, Chairman of the Barbie, Techlead, etc. |
            =============================================================== 
